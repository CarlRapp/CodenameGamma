...
const D3D11_INPUT_ELEMENT_DESC InputLayoutDesc::Terrain[5] = 
{
	{"POSITION",     0, DXGI_FORMAT_R32G32B32_FLOAT,	0, 0,  D3D11_INPUT_PER_VERTEX_DATA, 0},
	{"NORMAL",       0, DXGI_FORMAT_R32G32B32_FLOAT,	0, 12, D3D11_INPUT_PER_VERTEX_DATA, 0},
	{"TEXCOORD",     0, DXGI_FORMAT_R32G32_FLOAT,		0, 24, D3D11_INPUT_PER_VERTEX_DATA, 0},
	{"TANGENT",      0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 32, D3D11_INPUT_PER_VERTEX_DATA, 0},
	{"BLENDDATA",    0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 48, D3D11_INPUT_PER_VERTEX_DATA, 0}
};
...
void InputLayouts::InitAll(ID3D11Device* device)
{
	...
	device->CreateInputLayout(InputLayoutDesc::Terrain, 5, passDesc.pIAInputSignature, passDesc.IAInputSignatureSize, &Terrain);
